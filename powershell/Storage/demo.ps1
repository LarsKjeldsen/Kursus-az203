...
az storage blob generate-sas -c "private" -n $blobName --permissions r -o tsv --expiry 2020-12-30T13:24Z
...
az storage message delete --id "3027db5b-ee8a-4a47-8185-8c7d6c15f6df" --pop-receipt "AgAAAAMAAAAAAAAAA9lCMXjc0wE=" -q $queueName
...
az storage file upload -s $fileShare --source "./examples.txt"
